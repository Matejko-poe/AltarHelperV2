    ...
    internal static class AltarModsConstants
    {
        ...
        public static readonly IReadOnlyList<(string Id, string Name, string Type)> AltarTypes = new List<(string, string, string)>
        {
           ("+#% to maximum Cold Resistance", "+10% to maximum Cold Resistance", "Boss"),
            ...
            ("#% chance for Enemies to drop Chilled Ground when Hitting you, no more than once every # seconds", "(25–35)% chance for Enemies to drop Chilled Ground when Hitting you, no more than once every 2 seconds", "Player"),
            ("#% chance for Enemies to drop Shocked Ground when Hitting you, no more than once every # seconds", "(25–35)% chance for Enemies to drop Shocked Ground when Hitting you, no more than once every 2 seconds", "Player"),
